  ...
  return (
    <section className="supplier-order-decision" aria-label="Banka transferi kararı">
      ...
      <div className="queue-actions">
        <button className="button button-primary" disabled={pending} onClick={() => void decide("APPROVE")} type="button">
          {pending ? "Kaydediliyor…" : "Transferi onayla"}
        </button>
        <button className="button button-secondary" disabled={pending} onClick={() => void decide("REJECT")} type="button">Transferi reddet</button>
      </div>
